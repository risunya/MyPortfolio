    ...
    return (
        <div className='about-wrapper'>
            ...
            <div className='about-info'>
                ...
                <div className="about-info__text">Кроме фронтенда, я либо занимаюсь аналитикой <span className='second-span'>(иногда)</span>, либо комплексным администрированием IT-систем 🤓 Также я очень люблю читать, а мой профиль <span className='second-span'>(LiveLib)</span> можно найти <a href="https://www.livelib.ru/reader/risunyaaa" target="_blank">тут!</a></div>
            </div>
        </div>
    )
}
